...
if df.empty or 'Genre' not in df.columns or 'Year' not in df.columns:
    st.error("The dataset is empty or missing required columns. Please check the dataset and try again.")
else:
    # Sidebar filters
